...
//                       <li key={member.id || i} style={{ marginBottom: '8px', borderBottom: '1px solid #eee', paddingBottom: '8px' }}>
...
//             <button
//               onClick={() => {
//                 if (newMember.name && newMember.id && newMember.phone && newMember.area) {
//                   const updated = { ...memberLists };
//                   updated[newMember.area] = [...updated[newMember.area], newMember];
//                   setMemberLists(updated);
...
//                 } else {
//                   alert('Please fill out all fields and select a committee area.');
//                 }
//               }}
//               style={{
//                 width: '100%',
